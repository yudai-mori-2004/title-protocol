// COSE_Sign1 パース・検証
//
// RFC 8152 に基づく COSE_Sign1 構造のパースと署名検証。
// 原著: Copyright Amazon.com, Inc. (aws-nitro-enclaves-cose, Apache-2.0)
// 変更: Automata Network — OpenSSL → RustCrypto への移植
// 変更: Title Protocol — 内部化、alloy 依存除去
...
/// COSE HeaderMap: CborValue キーと CborValue 値のマップ。
...
/// RFC 8152 Section 4.4: Sig_structure
