...
- **Solana program**: GlobalConfig PDA management (Anchor)
- **Vendor implementation**: AWS Nitro Enclaves (`vendor-aws` feature flag)
- **Deployment**: Terraform + setup scripts for AWS Nitro nodes
